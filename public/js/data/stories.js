...
const MOLTACA_STORIES = [
  ...
  // 2. Village Development Initiative
  {
    ...
    date: "أكتوبر 2016",
    source: "مبادرات ميدانية موثقة — بالجهود الذاتية",
    ctaText: "استعراض ألبومات المبادرة",
    summary: "دشن أعضاء وأهالي الملتقى حملات ميدانية بالجهود الذاتية شملت صيانة كوبري شبانة، وتصنيع أول بوابة مضيئة لمدخل القرية، وإنارة مقابر القرية بالكامل بالتعاون مع المتطوعين.",
    image: "assets/activities/village_development_works.jpg",
    url: "#initiatives-showcase",
    location: "مداخل القرية وكوبري شبانة والمقابر",
    highlights: [
      "مبادرات بالجهود الذاتية الخالصة بمشاركة واسعة من شباب وأهالي القرية والمغتربين",
      "صيانة وتأهيل كوبري شبانة، وتركيب أول بوابة مضيئة، وإنارة المقابر بالكامل",
  ...
  // 12. Additional Facebook Source: Quran Competition Honors
  {
    ...
    url: "https://www.facebook.com/share/v/1FjCqNB2Ap/?mibextid=wwXIfr",
    location: "مسجد التوحيد — قصاصين الأزهار",
    highlights: [
  ...
  // NEW — Ramadan 180 Food Boxes Initiative
  {
    id: "story-ramadan-boxes-2024",
    type: "community-initiative",
    title: "١٨٠ شنطة رمضان بالخير — توزيع سري ليلي على المستحقين بكشف مسجد التوحيد",
    date: "أول يوم رمضان",
    source: "ملتقى أبناء قصاصين الأزهار — فيسبوك",
    ctaText: "منشور المبادرة الأصلي",
    summary: "وزّع الملتقى ١٨٠ شنطة غذائية بمحتويات تكفي لـ١٠ أيام من رمضان الكريم، مستخرجة بكشف مصفى ومحقق من مسجد التوحيد. جرى التوزيع سراً بين الساعة العاشرة مساءً والواحدة فجراً بالتكتك — يُوضع الكيس أمام الباب ويُقرع الجرس ثم ينصرف الموزع دون أن يُعرَّف — إيماناً بقوله تعالى: «وإن تخفوها وتؤتوها الفقراء فهو خير لكم». كل شنطة بـ300 جنيه، وتحتوي على: أرز، سكر، سمن، زيت، شاي، عدس، شعرية، مكرونة، فاصوليا، صلصة، بلح، عصير، ملح، جبنة، فول، لحمة.",
    image: "assets/images/481675482_9260292977391804_6357283331046929696_n.jpg",
    url: "https://www.facebook.com/share/p/14sanCGdJCL/?mibextid=wwXIfr",
    location: "قصاصين الأزهار — مسجد التوحيد",
    highlights: [
      "١٨٠ أسرة مستحقة حُدِّدت بكشف مُصفّى ومُراجَع من مسجد التوحيد بحضور متبرعين ومتطوعين",
      "توزيع ليلي سري تام — بلا تصوير، بلا إعلان، بلا انتظار شكر — عملاً بمبدأ إخفاء الصدقة",
      "كل شنطة بـ300 جنيه تحتوي 16 صنفاً غذائياً تكفي لعشرة أيام من شهر رمضان الكريم",
      "الهدف المقبل: التوسع لـ100 شنطة إضافية بإذن الله بدعم أبناء القرية والمتبرعين"
    ]
  }
];
